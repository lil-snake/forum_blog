  ...
  <div id="login">
    ...
    <div class="loginFrom" v-show="show == 1">
      ...
      <div class="body">
        <div class="space"></div>
        <div class="space"></div>
        <el-input placeholder="请输入用户名" v-model="loginFrom.username" prefix-icon="el-icon-user" clearable>
        </el-input>
        <div class="space"></div>
        <div class="space"></div>
        <el-input placeholder="请输入密码" v-model="loginFrom.password" prefix-icon="el-icon-lock" show-password>
        </el-input>
        <div class="space"></div>
        <div class="space"></div>
        <div class="captcha">
          <div class="captcha-left" @keyup.enter="sendLogin">
            <el-input placeholder="请输入右边验证码" v-model="loginFrom.captcha" prefix-icon="el-icon-s-grid">
            </el-input>
          </div>
    ...
    <div class="register" v-show="show == 2">
      ...
      <div class="body">
        <div class="space"></div>
        <div class="space"></div>
        <el-input placeholder="请输入用户名" v-model="register.username" prefix-icon="el-icon-user" clearable>
        </el-input>
        <div class="space"></div>
        <div class="space"></div>
        <el-input placeholder="请输入密码" v-model="register.password" prefix-icon="el-icon-lock" show-password>
        </el-input>
        <div class="space"></div>
        <div class="space"></div>
        <el-input placeholder="请确认密码" v-model="register.password2" prefix-icon="el-icon-lock" show-password>
        </el-input>
        <div class="space"></div>
        <div class="space"></div>
        ...
        <div class="captcha">
          <div class="captcha-left">
            <el-input placeholder="请输入右边验证码" v-model="register.captcha" prefix-icon="el-icon-s-grid">
            </el-input>
          </div>
          <div class="captcha-right" title="看不清楚？换一张" @click="changeImgCode">
...
export default {
  ...
  methods: {
    ...
    sendLogin() {
      ...
      function isIPv4Valid(address) {
        var ipv4Pattern = /^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$/; 
