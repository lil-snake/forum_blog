    ...
    <div class="error">
      <div class="container-floud">
        <div style="text-align: center">
          ...
          <el-button @click="goHome" size="large" style="width: 150px;background: linear-gradient(to top, gray 0%, #ec758b 51%, gray 100%);">
...
<style scoped>
  ...
  .error .digit {
    ...
    top: 8%;
    color: white;
    background: linear-gradient(to top, gray 0%, #000000 51%, gray 100%);
    border-radius: 50%;
    display: inline-block;
    transform: skew(45deg);
  }
